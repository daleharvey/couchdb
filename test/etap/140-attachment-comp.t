...
create_1st_text_att() ->
    {ok, Code, _Hdrs, _Body} =
        ibrowse:send_req(db_url() ++ "/testdoc1/readme.txt",
...
create_1st_png_att() ->
    {ok, Code, _Hdrs, _Body} =
        ibrowse:send_req(db_url() ++ "/testdoc2/icon.png",
...
create_2nd_text_att() ->
    ...
    {ok, Code, _Hdrs, _Body} =
        ibrowse:send_req(db_url() ++ "/testdoc3",
                         [{"Content-Type", "application/json"}],
                         put,
                         list_to_binary(couch_util:json_encode(DocJson))),    
...
create_2nd_png_att() ->
    ...
    io:format("~p~n", [DocJson]),
    
    {ok, Code, _Hdrs, _Body} =
        ibrowse:send_req(db_url() ++ "/testdoc4",
                         [{"Content-Type", "application/json"}],
                         put,
                         list_to_binary(couch_util:json_encode(DocJson))),    
...
create_already_compressed_att(DocUri, AttName) ->
    {ok, Code, _Hdrs, _Body} =
        ibrowse:send_req(DocUri ++ "/" ++ AttName,
...
test_get_1st_text_att_with_accept_encoding_gzip() ->
    ...
    {ok, Code, Headers, Body} = ibrowse:send_req(
...
test_get_doc_with_1st_text_att() ->
    {ok, Code, _Headers, Body} =
        ibrowse:send_req(db_url()  ++ "/testdoc1?attachments=true",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
...
test_1st_text_att_stub() ->
    {ok, Code, _Headers, Body} =
        ibrowse:send_req(db_url() ++ "/testdoc1?att_encoding_info=true",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Json = couch_util:json_decode(Body),
...
test_get_doc_with_1st_png_att() ->
    {ok, Code, _Headers, Body} =
        ibrowse:send_req(db_url() ++ "/testdoc2?attachments=true",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Json = couch_util:json_decode(Body),
...
test_1st_png_att_stub() ->
    {ok, Code, _Headers, Body} =
        ibrowse:send_req(db_url() ++ "/testdoc2?att_encoding_info=true",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Json = couch_util:json_decode(Body),
...
test_get_2nd_text_att_with_accept_encoding_gzip() ->
    {ok, Code, Headers, Body} =
        ibrowse:send_req(db_url() ++ "/testdoc3/readme.txt",
                         [{"Accept-Encoding", "gzip"}],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Gziped = lists:member({"Content-Encoding", "gzip"}, Headers),
...
test_get_2nd_png_att_without_accept_encoding_header() ->
    {ok, Code, Headers, Body} =
        ibrowse:send_req(db_url() ++ "/testdoc4/icon.png",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Gziped = lists:member({"Content-Encoding", "gzip"}, Headers),
...
test_get_doc_with_2nd_text_att() ->
    {ok, Code, _Headers, Body} =
        ibrowse:send_req(db_url() ++ "/testdoc3?attachments=true",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Json = couch_util:json_decode(Body),
...
test_2nd_text_att_stub() ->
    {ok, Code, _Headers, Body} =
        ibrowse:send_req(db_url() ++ "/testdoc3?att_encoding_info=true",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Json = couch_util:json_decode(Body),
...
test_get_doc_with_2nd_png_att() ->
    {ok, Code, _Headers, Body} =
        ibrowse:send_req(db_url() ++ "/testdoc4?attachments=true",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Json = couch_util:json_decode(Body),
...
test_2nd_png_att_stub() ->
    {ok, Code, _Headers, Body} =
        ibrowse:send_req(db_url() ++ "/testdoc4?att_encoding_info=true",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Json = couch_util:json_decode(Body),
...
test_get_already_compressed_att_stub(DocUri, AttName) ->
    {ok, Code, _Headers, Body} =
        ibrowse:send_req(DocUri ++ "?att_encoding_info=true",
                         [],
                         get),
    etap:is(Code, "200", "HTTP response code is 200"),
    Json = couch_util:json_decode(Body),
